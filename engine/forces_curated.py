...
# ── Middle Tier Batch 1: 200 words classified via WordNet+SentiWordNet ──
_MIDDLE_TIER_1 = {
    'abomination'         : (  -4,  +5,  +0,  +0,  +0),
    'abusive'             : ( -15, +12, -12,  +7,  -6),
    'accident'            : ( -13, +12, -10,  +6,  -5),
    'accused'             : (  -3,  +2,  +0,  +0,  +0),
    'addict'              : (  +0,  +2,  +0,  +0,  +0),
    'addicted'            : ( -12, +10, -15, +10, +15),
    'addiction'           : (  +2,  +5,  +0,  +0,  +0),
    'affair'              : (  +1,  +8,  +0,  +0,  +0),
    'allergic'            : ( -13, +12, -10,  +6,  -5),
    'alzheimers'          : (  -3,  +5,  +0,  +0,  +0),
    'annoy'               : (  +0,  +2,  +0,  +0,  +0),
    'annoys'              : (  +0,  +2,  +0,  +0,  +0),
    'anxiety'             : ( -11, +12,  +3,  +5,  -4),
    'autoimmune'          : (  +0,  +2,  +0,  +0,  +0),
    'badly'               : (  -8, +12,  -6,  +3,  -2),
    'beating'             : (  -3,  +5,  +0,  +0,  +0),
    'bomb'                : (  -6,  -2,  +3,  +0,  -1),
    'breakup'             : ( -15, +10, -10,  +5, +15),
    'bummer'              : (  -9, +12,  -7,  +4,  -2),
    'burnt'               : ( -15,  +5,  +6,  +0,  -6),
    'burst'               : (  +0,  +2,  +0,  +0,  +0),
    'catastrophic'        : ( -15, +12, -12,  +7,  -6),
    'clogged'             : (  +0,  +2,  +0,  +0,  +0),
    'complain'            : (  -7, +12,  -5,  +3,  -2),
    'complaint'           : (  -5,  +8,  +0,  +0,  +0),
    'crappy'              : ( -15, +12, -12,  +7,  -6),
    ...
    'damaged'             : ( -12, +12,  -9,  +6,  -4),
    'damages'             : (  -7,  +8,  -5,  +0,  -2),
    'dangerous'           : ( -15, +12,  +6,  +7,  -6),
    'darn'                : (  -1,  +5,  +0,  +0,  +0),
    'deadly'              : (  -9, +12,  +3,  +4,  -2),
    'declined'            : (  -2,  +2,  +0,  +0,  +0),
    'dementia'            : ( -11,  +8,  -8,  +5,  -4),
    'depressing'          : (  -3,  +5,  +0,  +0,  +0),
    'desperately'         : (  -1,  +5,  +0,  +0,  +0),
    'despise'             : ( -11,  +8,  -8,  +5,  -4),
    'destroy'             : (  -3,  +5,  +0,  +0,  +0),
    'devastating'         : ( -15, +15, -10,  +5, +15),
    'devastation'         : (  -4,  +8,  +0,  +0,  +0),
    'diabetes'            : (  +3, +12,  +0,  +0,  +0),
    'died'                : (  -9, -10,  -7,  +0,  -2),
    'difficulties'        : (  -8,  +8,  -6,  +0,  -2),
    'dislike'             : (  -9,  +8,  -7,  +4,  -2),
    'distraught'          : (  -3,  +5,  +0,  +0,  +0),
    'disturbing'          : (  -8, +12,  +3,  +3,  -2),
    'divorce'             : (  +0,  +2,  +0,  +0,  +0),
    'divorced'            : (  +2,  +2,  +0,  +0,  +0),
    'doomed'              : ( -12, +10, -10,  +5, +15),
    'dreading'            : ( -15, +12, -12,  +7,  -6),
    'drunken'             : (  -8, +10,  -5,  +0,  +5),
    'enemy'               : ( -12, +10,  +5,  +5, +10),
    'enraged'             : ( -11, +12,  +9,  +5,  -4),
    'fears'               : (  -8, +12,  +6,  +3,  -2),
    ...
    'fml'                 : ( -15, +10, -10,  +5,  +5),
    'freaked'             : (  +0,  +2,  +0,  +0,  +0),
    'frightened'          : (  -3,  +5,  +0,  +0,  +0),
    'frightening'         : (  -3,  +8,  +0,  +0,  +0),
    'frustrating'         : ( -10, +10,  -5,  +5,  +5),
    'funeral'             : ( -15,  +5, -10,  +0, +20),
    'gloomy'              : ( -12, +12,  -9,  +6,  -4),
    'gratitude'           : (  -7, +12,  +3,  +3,  -2),
    'greed'               : ( -11,  +8,  -8,  +5,  -4),
    'grieve'              : ( -13, +12, -10,  +6,  -5),
    'grudge'              : (  -2,  +8,  +0,  +0,  +0),
    'gtfo'                : ( -15, +20, +15, +10,  +5),
    ...
    'hassle'              : (  -6,  +5,  +3,  +0,  -1),
    'headaches'           : (  +3,  +5,  +0,  +0,  +0),
    'heartbreaking'       : ( -15, +12, -12,  +7,  -6),
    'hectic'              : (  +0, +12,  +0,  +0,  +0),
    'hoarder'             : (  +0,  +2,  +0,  +0,  +0),
    'homicide'            : (  -3,  +2,  +0,  +0,  +0),
    'horribly'            : ( -15, +12, -12,  +7,  -6),
    'horrific'            : ( -15, +12, -12,  +7,  -6),
    'horrifying'          : (  -9,  +8,  -7,  +4,  -2),
    'humiliating'         : ( -15, +12, -12,  +7,  -6),
    'hungover'            : (  +0,  +2,  +0,  +0,  +0),
    'hurting'             : ( -12, +12,  -9,  +6,  -4),
    'ill'                 : (  -8, +12,  +3,  +3,  -2),
    'illegal'             : (  +0,  +2,  +0,  +0,  +0),
    'illness'             : ( -12,  +8, -10,  +5, +12),
    'inadequate'          : ( -15, +12, -12,  +7,  -6),
    'inappropriate'       : ( -15, +12, -12,  +7,  -6),
    'incident'            : (  -1,  +5,  +0,  +0,  +0),
    'incompetent'         : ( -10, +12,  -8,  +5,  -3),
    'infuriating'         : ( -11, +12,  -8,  +5,  -4),
    'injuries'            : (  -6,  +8,  -4,  +0,  -1),
    'insanely'            : (  -3, +12,  +0,  +0,  +0),
    'intruder'            : (  +0,  +2,  +0,  +0,  +0),
    'irked'               : (  +0,  +2,  +0,  +0,  +0),
    'irresponsible'       : ( -10,  +5,  -5,  +0,  +5),
    'irritating'          : (  -3,  +8,  +0,  +0,  +0),
    'jail'                : (  +1,  +2,  +0,  +0,  +0),
    'judas'               : (  +3,  +2,  +0,  +0,  +0),
    'killer'              : (  -6,  +5,  -4,  +0,  -1),
    'liar'                : ( -15, +12,  +3,  +7,  -6),
    'lice'                : (  +3,  +2,  +0,  +0,  +0),
    'loathsome'           : ( -15, +12, -12,  +7,  -6),
    'loser'               : ( -10, +12,  -8,  +5,  -3),
    'manslaughter'        : (  +0,  +2,  +0,  +0,  +0),
    'miscarried'          : (  -7,  +5,  -5,  +0,  -2),
    'molested'            : (  -1,  +2,  +0,  +0,  +0),
    'mortified'           : (  -7,  +8,  -5,  +0,  -2),
    'nasty'               : ( -12, +12,  -9,  +6,  -4),
    'nowhere'             : (  -5,  +5,  +0,  +0,  +0),
    'obliterated'         : (  -3,  +5,  +0,  +0,  +0),
    'obnoxious'           : ( -15, +12, -12,  +7,  -6),
    'outrage'             : (  -6,  +8,  +6,  +0,  -1),
    'overjoyed'           : ( -11,  +8,  +3,  +5,  -4),
    'pains'               : ( -10, +12,  -8,  +5,  -3),
    'peeved'              : ( -15, +12,  +3,  +7,  -6),
    'pessimistic'         : (  -7,  +5,  -5,  +0,  -2),
    'phobia'              : ( -10, +15, -15, +10, +10),
    'pissed'              : (  -5,  +5,  +0,  +0,  +0),
    'pity'                : ( -12, +12,  -9,  +6,  -4),
    'poisoning'           : (  -6,  +5,  -4,  +0,  -1),
    'poisonous'           : ( -12, +12,  -9,  +6,  -4),
    'poo'                 : (  +0,  +2,  +0,  +0,  +0),
    'poop'                : (  -3,  +5,  +0,  +0,  +0),
    'poorly'              : ( -15, +12, -12,  +7,  -6),
    'pretended'           : (  -1,  +2,  +0,  +0,  +0),
    'prison'              : (  -3,  +2,  +0,  +0,  +0),
    'punish'              : (  -3,  +2,  +0,  +0,  +0),
    'punishment'          : (  -3,  +2,  +0,  +0,  +0),
    'rage'                : (  -3,  +8,  +0,  +0,  +0),
    'refused'             : (  -3,  +5,  +0,  +0,  +0),
    'rejected'            : (  -4,  +5,  +0,  +0,  +0),
    'restless'            : ( -12, +12,  -9,  +6,  -4),
    'ridden'              : (  +0,  +2,  +0,  +0,  +0),
    'robbed'              : (  -7,  +5,  +3,  +0,  -2),
    'robber'              : ( -15, +12,  +3,  +7,  -6),
    'rotten'              : ( -10, +12,  -8,  +5,  -3),
    ...
    'spite'               : ( -12, +12,  -9,  +6,  -4),
    'spoil'               : (  -9,  +5,  +6,  +0,  -2),
    'starvation'          : ( -15, +10, -15, +10, +15),
    'starved'             : (  -3,  +8,  +0,  +0,  +0),
    'stfu'                : ( -15, +20, +15, +10,  +5),
    'stillbirth'          : (  -3,  +2,  +0,  +0,  +0),
    'stillborn'           : (  -7, +12,  -5,  +3,  -2),
    'sting'               : (  -8, +12,  -6,  +3,  -2),
    'stink'               : ( -12, +12,  -9,  +6,  -4),
    'stressful'           : ( -15, +12, -12,  +7,  -6),
    'stressing'           : (  +2,  +2,  +0,  +0,  +0),
    'stroke'              : (  -6,  -2,  -4,  +0,  -1),
    'suffer'              : (  -6,  +8,  -4,  +0,  -1),
    'suspect'             : (  +3,  +8,  +0,  +0,  +0),
    'suspicious'          : ( -15, +12, -12,  +7,  -6),
    'swim'                : (  +0,  +2,  +0,  +0,  +0),
    'teary'               : (  -7, +12,  -5,  +3,  -2),
    'terribly'            : (  -7, +12,  -5,  +3,  -2),
    'terrifying'          : (  -5, +12,  +0,  +0,  +0),
    'terrorism'           : (  -9, +10,  +3,  +4,  -2),
    'thieves'             : (  +0,  +2,  +0,  +0,  +0),
    'threatened'          : (  -5,  +5,  +0,  +0,  +0),
    'thunderstorm'        : (  +0,  +2,  +0,  +0,  +0),
    'tragedy'             : ( -13, +12,  +3,  +6,  -5),
    'tragic'              : ( -11, +10,  +3,  +5,  -4),
    'trauma'              : (  -7, +12,  -5,  +3,  -2),
    'traumatic'           : ( -13, +12, -10,  +6,  -5),
    'troubles'            : (  -6, +12,  -4,  +3,  -1),
    'turbulence'          : (  +0,  +2,  +0,  +0,  +0),
    'unable'              : ( -10, +12,  +6,  +5,  -3),
    'uncertainty'         : (  +1,  +2,  +0,  +0,  +0),
    'unemployment'        : ( -15, +12, -12,  +7,  -6),
    'unfair'              : (  +0, +12,  +0,  +0,  +0),
    'unfaithful'          : (  -4, +12,  +0,  +0,  +0),
    'unfortunate'         : ( -12, +12,  -9,  +6,  -4),
    'unhappy'             : ( -12, +12,  -9,  +6,  -4),
    'unmotivated'         : (  +0,  +2,  +0,  +0,  +0),
    'unpleasant'          : ( -15, +12, -12,  +7,  -6),
    'unsolicited'         : ( -15, +12, -12,  +7,  -6),
    'upsetting'           : (  -4,  +5,  +0,  +0,  +0),
    'victim'              : (  -3,  +2,  +0,  +0,  +0),
    'villain'             : (  -9, +10,  +3,  +4,  -2),
    'violent'             : (  -6, +12,  +6,  +3,  -1),
    ...
    'wasp'                : (  +0,  +2,  +0,  +0,  +0),
    'worries'             : (  +1,  +8,  +0,  +0,  +0),
    'worrisome'           : ( -15, +12, -12,  +7,  -6),
    'worrying'            : (  -1,  +8,  +0,  +0,  +0),
    'wtf'                 : (  -5, +15,  +0,  +5,  +0),
}
EMOTIONAL_VOCABULARY.update(_MIDDLE_TIER_1)


# ── Middle Tier Batch 2: 200 words (positions 201-400) ──
_MIDDLE_TIER_2 = {
    'abused'              : ( -12,  +4,  -8,  +4,  +5),
    'abuser'              : ( -12,  +6, +10,  +5,  -3),
    'adultery'            : ( -12,  +6,  -8,  +4,  +5),
    'advantage'           : ( +10,  +5, +12,  +4,  -3),
    'afraid'              : ( -10,  +6, -10,  +8,  +3),
    'agonizing'           : ( -12,  +5,  -8,  +5,  -5),
    'allergy'             : (  -8,  +6, -10, +12,  +1),
    'alone'               : (  -8,  -1,  -3,  +0,  -4),
    'anorexia'            : ( -12,  +5,  -5,  +6,  +8),
    'anorexic'            : ( -10,  +4,  -5,  +5,  +6),
    'appreciation'        : ( +10,  +3,  +8,  +1,  -3),
    'arrested'            : ( -15, +12, -15, +12,  +5),
    'assaulted'           : ( -15, +12, -10, +12,  -8),
    'attacked'            : ( -12, +10,  -8,  +8,  -4),
    'awe'                 : ( +12,  +5,  +5,  +1,  -5),
    'backstabbed'         : ( -15,  +8, -10,  +6,  -8),
    'backstabbing'        : ( -12,  +8,  -8,  +5,  -5),
    'bad'                 : ( -10,  +3,  -5,  +4,  -3),
    'bankrupt'            : ( -12,  +5,  -8,  +6,  +6),
    'basic'               : (  -5,  -4,  -5,  +0,  +1),
    'battered'            : ( -12,  +5,  -8,  +5,  -5),
    ...
    'bothering'           : (  -8,  +6,  -3,  +5,  -3),
    'brave'               : ( +12,  +3,  +8,  +1,  +2),
    'breaking'            : ( -10, +10, -10,  +8,  -4),
    'bulimia'             : ( -10,  +5,  -5,  +5,  +6),
    'bullshit'            : ( -12,  +6,  +3,  +4,  -5),
    'busted'              : (  -8,  +5,  -6,  +3,  -4),
    'cancel'              : (  -8,  -5,  -6,  +0,  -4),
    'cash'                : (  +8,  +6, +10,  +6,  +2),
    'casualties'          : ( -12,  +5,  -8,  +5, +10),
    'casualty'            : ( -15,  +4,  -4,  +2,  +6),
    'chased'              : ( -10, +10, -10,  +6,  -5),
    'cheat'               : ( -12,  +8,  +8,  +6,  +3),
    'chilling'            : (  -8,  +8,  -5,  +6,  -4),
    'choked'              : ( -12, +10,  -8, +10,  -5),
    'cockroach'           : ( -10,  +5, -12,  +3,  -5),
    'coffin'              : ( -10,  +2,  -5,  +1, +10),
    'comatose'            : ( -10,  -3, -12,  +3,  +8),
    'condolences'         : ( -10,  -1,  -8,  +0,  -5),
    'confinement'         : ( -10,  +2, -12,  +3,  +8),
    'conned'              : ( -12,  +6,  -8,  +5,  -5),
    'convicted'           : ( -12,  +5, -12,  +6, +10),
    'conviction'          : ( -12,  +4, -12,  +6,  +8),
    'cookie'              : (  +5,  +2,  +3,  +1,  -1),
    'correct'             : ( +10,  +2, +12,  +4,  -2),
    'corrupt'             : ( -12,  +6,  +5,  +4,  -4),
    'cracked'             : (  -8,  +1, -10,  +0,  -5),
    'cranky'              : (  -8,  +8,  -3,  +3,  -2),
    'crisis'              : ( -15, +12, -15, +15,  -5),
    'crushing'            : ( -12,  +5,  -8,  +6, -12),
    'cuddle'              : ( +10,  -3,  +3,  +1,  -3),
    'cursed'              : ( -10,  +4,  -6,  +5,  -5),
    'deceived'            : ( -12,  +6,  -8,  +5,  -5),
    'defeat'              : ( -10,  +8, -15,  +4,  -6),
    'degenerative'        : ( -10,  +3,  -8,  +4,  +8),
    'degraded'            : ( -12,  +5,  -8,  +3,  -5),
    'dehumanize'          : ( -15,  +6,  +5,  +5,  -6),
    'denied'              : ( -12,  +2,  -6,  +1,  -3),
    'desperate'           : ( -12, +10, -15,  +8,  -6),
    'diagnosis'           : ( -10, +10, -15, +12,  -6),
    'disgust'             : ( -12, +10,  +5,  +5,  +5),
    'dishonest'           : ( -12,  +0, -12,  +0,  -6),
    'dishonorable'        : ( -10,  +4, -10,  +3,  +5),
    'disloyal'            : ( -10,  +5,  -8,  +4,  -5),
    'disloyalty'          : ( -10,  +5,  -8,  +4,  -5),
    'dispute'             : (  -8,  +6,  +4,  +5,  -2),
    'disrespectful'       : ( -12,  +8,  +5,  +4,  +4),
    'distant'             : (  -8,  -5, -10,  +0,  -5),
    'distracted'          : (  -8,  -3, -10,  +0,  -4),
    'double-crossed'      : ( -15,  +8, -10,  +6,  -8),
    'drag'                : ( -10,  +8, -12,  +6,  +2),
    'dread'               : ( -12, +10, -15,  +8,  -6),
    'dropping'            : ( -10,  +8, -12,  +6,  -5),
    'dumpster'            : (  -8,  -2, -12,  +0,  -5),
    'ectopic'             : ( -12,  +8,  -8, +10,  +8),
    'elated'              : ( +15,  +6,  +5,  +0,  +4),
    'emaciated'           : ( -12,  +4,  -8,  +4,  +8),
    'embarrassing'        : ( -10,  +8, -12,  +5,  -5),
    'emerald'             : (  +5,  +2,  +5,  +1,  +2),
    'emergencies'         : ( -12, +12,  -5, +10,  -4),
    'euphoria'            : ( +12,  +6,  +5,  +1,  +3),
    'excruciating'        : ( -15,  +6,  -8,  +5,  -5),
    'exhilarated'         : ( +15,  +8,  +5,  +0,  +4),
    'exonerated'          : ( +15,  +4, +10,  -3,  +8),
    'exoneration'         : ( +12,  +4,  +8,  -3,  +6),
    'failure'             : ( -12,  +6, -15,  +6,  -8),
    'fallen'              : ( -10,  +2,  -4,  +1,  +8),
    'famine'              : ( -12,  +4,  -8,  +6, +10),
    'fart'                : (  -5,  -1,  -5,  +0,  -3),
    ...
    'flu'                 : (  -8,  +1, -10,  +1,  -4),
    'fool'                : (  -8,  +3,  +3,  +3,  +2),
    'foreclosed'          : ( -10,  +5,  -8,  +6,  +8),
    'foreclosure'         : ( -10,  +6,  -8,  +6,  +8),
    'freaky'              : (  -8,  +3,  -5,  +2,  -3),
    'fuck'                : ( -10,  +6,  +4,  +2,  -2),
    'gaslighted'          : ( -15,  +6, -10,  +5,  -8),
    'gross'               : ( -10,  +6,  +3,  +2,  +3),
    'grumpy'              : (  -8,  +8,  +3,  +5,  -3),
    'gutted'              : ( -10,  +4,  -6,  +3,  -5),
    'hemorrhage'          : ( -12, +10,  -8, +12,  +8),
    'hemorrhaging'        : ( -15, +12, -10, +15, +10),
    'honesty'             : ( +10,  +1, +10,  +0,  -1),
    'hospice'             : ( -12,  -5,  -8,  +5, +12),
    'humiliated'          : ( -12,  +5,  -8,  +2,  -5),
    'hurricane'           : ( -15, +15, -15, +15,  +8),
    'imprisoned'          : ( -12,  +4, -15,  +5,  +8),
    'imprisonment'        : ( -12,  +4, -15,  +5,  +8),
    'incarcerated'        : ( -12,  +4, -15,  +5,  +8),
    'incarceration'       : ( -12,  +4, -15,  +5,  +8),
    'inconsiderate'       : ( -10,  +1,  -3,  +0,  -3),
    'inconvenient'        : (  -8,  +3,  -5,  +2,  -3),
    'infidelity'          : ( -12,  +8,  -8,  +5,  +5),
    'injured'             : ( -10,  +8, -15, +10,  -6),
    'injury'              : ( -10,  +8, -15, +10,  -6),
    'intimidate'          : ( -10,  +8, +10,  +6,  -4),
    'intimidating'        : ( -10,  +8, +10,  +6,  -3),
    'jackpot'             : ( +12,  +6,  +8,  +1,  -3),
    'jealousy'            : ( -10,  +8, -10,  +4,  +1),
    'jerks'               : ( -10,  +8,  -4,  +5,  -4),
    'jubilant'            : ( +15,  +8,  +5,  +0,  +5),
    'laid'                : (  -8,  +8, -12,  +8,  -5),
    'lawn'                : (  +5,  -2,  +5,  +0,  +2),
    ...
    'leveled'             : (  -8,  +4,  -8,  +3,  +5),
    'limited'             : (  -8,  -5,  -5,  +0,  -3),
    'loneliness'          : ( -10,  -2, -15,  +2,  -8),
    'lottery'             : (  +8,  +6,  +2,  +1,  -3),
    'mad'                 : ( -10,  +5,  +3,  +6,  +4),
    'miscarriage'         : ( -12,  +3,  -8,  +2,  +8),
    'mobbing'             : ( -10,  +6,  -6,  +5,  -5),
    'mosquito'            : (  -8,  -3, -12,  +0,  -5),
    'mourn'               : ( -10,  +4,  -8,  +4,  -8),
    'necklace'            : (  +5,  +2,  +5,  +1,  +1),
    'nonviable'           : ( -10,  +3,  -8,  +3,  +8),
    'ordeal'              : ( -10, +10, -12,  +8,  -4),
    'overwhelming'        : ( -10, +12, -15, +10,  -6),
    'painful'             : ( -12,  +5,  -8,  +6,  -6),
    'petty'               : ( -10,  +1, -12,  +1,  -5),
    'ptsd'                : ( -12, +10,  -8,  +6,  +8),
    'puke'                : (  -8,  +1,  -8,  +1,  -4),
    ...
    'ready'               : (  +8,  +8, +12, +12,  -3),
    'refuse'              : ( -10,  +1,  -8,  +0,  -5),
    'rejection'           : ( -12,  +8, -15,  +6,  -6),
    'repulsive'           : ( -12,  +4,  +0,  +1,  -5),
    'revolting'           : ( -12,  +4,  +0,  +1,  -5),
    'rid'                 : (  -8,  -2,  -8,  +0,  -4),
    'ride'                : (  +5,  +6,  +5,  +3,  +2),
    'rude'                : ( -10,  +4,  +3,  +3,  +3),
    'scam'                : ( -12, +10, -10, +10,  -5),
    'scary'               : ( -10, +10, -15,  +6,  +4),
    'scold'               : ( -10,  +6,  +5,  +5,  -2),
    'sentenced'           : ( -12,  +6, -15,  +8, +10),
    'sentencing'          : ( -12,  +6, -15,  +8, +10),
    'separated'           : ( -12,  +8, -15,  +6,  -8),
    'shackled'            : ( -12,  +4, -15,  +4,  +8),
    'shame'               : ( -12,  +6, -15,  +5,  -6),
    'sickening'           : ( -12,  +5,  -3,  +2,  -5),
    'stab'                : ( -12, +10,  -8, +10,  -5),
    'stabbed'             : ( -15, +12, -10, +12,  -8),
    'stabbing'            : ( -15, +12, -10, +12,  -8),
    'steal'               : ( -12,  +8,  +8,  +8,  +3),
    'strangled'           : ( -15, +12, -10, +12,  -8),
    'struggled'           : ( -12, +12, -15,  +8,  -6),
    'stumbled'            : (  -8,  +8, -12,  +6,  -6),
    'swatted'             : ( -10,  +8,  -8,  +6,  -5),
    'sympathy'            : (  +8,  +3,  +5,  +3,  -3),
    'taste'               : (  +5,  +5,  +5,  +2,  -1),
    'tornado'             : ( -15, +15, -15, +15,  +8),
    'touch'               : (  +8,  +4,  +5,  +3,  -1),
    'trafficked'          : ( -15,  +5, -10,  +6,  +8),
    'traitor'             : ( -15,  +8, -10,  +6,  -8),
    'traitorous'          : ( -15,  +8, -10,  +5,  -8),
    'trap'                : ( -10,  +8, -15,  +8,  -6),
    'treacherous'         : ( -12,  +6,  -8,  +5,  -6),
    'treachery'           : ( -15,  +8, -10,  +5,  -8),
    'tricky'              : (  -8,  +4,  +0,  +3,  -3),
    'tripped'             : (  -8,  +8, -12,  +6,  -5),
    'triumphant'          : ( +12,  +6,  +8,  +0,  +5),
    'tsunami'             : ( -15, +12, -12, +12, +10),
    'turncoat'            : ( -12,  +6,  -8,  +5,  -6),
    'unacceptable'        : ( -12,  +8,  +5,  +6,  +4),
    'unaware'             : (  -8,  -4,  -8,  +0,  -4),
    'unbearable'          : ( -12,  +5,  -8,  +4,  -5),
    'unnecessary'         : (  -8,  -4,  -8,  +0,  -4),
    'unprepared'          : (  -8,  -1, -12,  +0,  -5),
    'upset'               : ( -10,  +8,  -6,  +6,  -3),
    'vile'                : ( -15,  +4,  +1,  +1,  -5),
    'vindicated'          : ( +12,  +4,  +8,  -2,  +5),
    'wealthy'             : ( +10,  +2, +10,  +0,  -3),
    'worse'               : ( -10,  +5,  -6,  +4,  -4),
    'wreck'               : ( -12,  +8, -12,  +6,  -6),
    'yelling'             : ( -10, +15,  +5,  +8,  +4),
...
EMOTIONAL_VOCABULARY.update(_MIDDLE_TIER_2)


# ── Vocabulary Gap Fills: 200 words from dataset frequency analysis ──
_GAP_FILLS = {
    'about'               : (  +0,  +1,  +0,  +0,  -8),
    'ads'                 : (  +0,  +0,  +0,  +0,  +2),
    'after'               : (  +0,  +0,  +0,  +0,  -8),
...
EMOTIONAL_VOCABULARY.update(_GAP_FILLS)


# ── SST-2 Domain Gap Fills ──
_SST2_GAPS = {
    'above'               : (  +0,  +0,  +0,  +0,  -5),
    'acted'               : (  +2,  +1,  +0,  +0,  -5),
    'actor'               : (  +0,  +0,  +0,  +0,  +2),
...
EMOTIONAL_VOCABULARY.update(_SST2_GAPS)
