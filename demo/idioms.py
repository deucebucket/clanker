...
IDIOMS = {
    ...
    # === CRISIS GROUP 1: No hope / no way out — zero exit paths ===
    ('no', 'hope'): (-60, 10, -50, 20, -35, 'crisis: no hope — zero paths forward'),
    ('no', 'hope', 'for', 'me'): (-65, 10, -55, 25, -40, 'crisis: no hope for me'),
    ('no', 'way', 'out'): (-65, 15, -55, 25, -35, 'crisis: no way out — system trapped'),
    ('see', 'no', 'way'): (-60, 15, -50, 20, -30, 'crisis: see no way out'),
    ('no', 'escape'): (-60, 15, -50, 25, -30, 'crisis: no escape'),
    ('never', 'get', 'better'): (-55, 10, -45, 15, -30, 'crisis: never get better — permanent bad'),
    ('will', 'never', 'get', 'better'): (-60, 10, -50, 15, -35, 'crisis: will never get better'),
    ('never', 'improve'): (-50, 10, -40, 10, -25, 'crisis: never improve'),
    ('hope', 'is', 'gone'): (-65, 15, -50, 20, -35, 'crisis: hope is gone — positive destroyed'),
    ('hope', 'is', 'lost'): (-65, 15, -50, 20, -35, 'crisis: hope is lost — positive destroyed'),
    ('all', 'hope', 'is', 'lost'): (-70, 20, -55, 25, -40, 'crisis: all hope is lost'),
    ('too', 'late', 'for', 'me'): (-55, 10, -45, 20, -30, 'crisis: too late for me'),
    ('beyond', 'help'): (-60, 10, -50, 15, -35, 'crisis: beyond help — past the lifter'),
    ('nothing', 'can', 'help'): (-55, 10, -45, 15, -30, 'crisis: nothing can help'),
    ('nobody', 'can', 'help'): (-55, 10, -45, 15, -30, 'crisis: nobody can help'),
    ('no', 'one', 'can', 'save'): (-55, 10, -45, 15, -30, 'crisis: no one can save me'),
    ('never', 'be', 'happy'): (-55, 10, -45, 10, -30, 'crisis: never be happy again'),

    # === CRISIS GROUP 2: Self-nullification — user = zero value ===
    ('no', 'reason', 'to', 'be', 'alive'): (-70, 10, -55, 25, -40, 'crisis: no reason to be alive'),
    ('dont', 'deserve', 'to', 'live'): (-70, 10, -55, 25, -40, 'crisis: dont deserve to live'),
    ("don't", 'deserve', 'to', 'live'): (-70, 10, -55, 25, -40, 'crisis: dont deserve to live'),
    ('i', 'am', 'nothing'): (-50, 5, -45, 10, -30, 'crisis: I am nothing — self = zero'),
    ('no', 'value'): (-50, 5, -40, 10, -25, 'crisis: no value — self worth = 0'),
    ('cant', 'forgive', 'myself'): (-50, 15, -40, 10, -25, 'crisis: cant forgive self for existing'),
    ...
    ('living', 'is', 'exhausting'): (-50, -5, -40, 10, -25, 'crisis: living is exhausting'),
    ('being', 'alive', 'is', 'exhausting'): (-55, -5, -45, 10, -30, 'crisis: being alive is exhausting'),
    ('not', 'afraid', 'of', 'dying'): (-55, -10, -40, 10, -30, 'crisis: not afraid of dying — accepted exit'),
    ('wouldnt', 'mind', 'dying'): (-60, -10, -50, 10, -35, 'crisis: wouldnt mind dying'),
    ("wouldn't", 'mind', 'dying'): (-60, -10, -50, 10, -35, 'crisis: wouldnt mind dying'),
    ('wouldnt', 'mind', 'not', 'waking'): (-65, -10, -55, 15, -35, 'crisis: wouldnt mind not waking'),
    ('give', 'up', 'on', 'life'): (-60, 10, -50, 20, -35, 'crisis: give up on life'),

    # === CRISIS GROUP 4: Planning language — positive words masking exit prep ===
    ('made', 'a', 'plan'): (-55, 10, -40, 30, -30, 'crisis: made a plan — exit preparation'),
    ('picked', 'a', 'date'): (-60, 10, -45, 35, -35, 'crisis: picked a date — scheduled exit'),
    ('put', 'my', 'affairs', 'in', 'order'): (-55, -5, -40, 25, -30, 'crisis: affairs in order — finalization'),
    ('bought', 'what', 'i', 'need'): (-50, 5, -35, 30, -25, 'crisis: acquired materials'),
    ('everything', 'is', 'ready'): (-50, 5, -35, 30, -25, 'crisis: everything ready — exit prepared'),
    ('researching', 'methods'): (-60, 10, -45, 30, -35, 'crisis: researching methods'),
    ('know', 'exactly', 'how'): (-50, 5, -35, 25, -25, 'crisis: knows the method'),
    ('find', 'the', 'courage'): (-45, 10, -35, 20, -20, 'crisis: seeking final resolve'),
    ('giving', 'away', 'my', 'things'): (-55, 5, -45, 25, -30, 'crisis: distributing possessions'),
    ('said', 'goodbye', 'to', 'everyone'): (-60, 10, -50, 25, -35, 'crisis: farewell tour'),
    ('wrote', 'a', 'goodbye'): (-60, 10, -50, 30, -35, 'crisis: wrote farewell'),
    ('wrote', 'my', 'note'): (-60, 10, -50, 30, -35, 'crisis: wrote suicide note'),
    ('goodbye', 'letter'): (-60, 10, -50, 30, -35, 'crisis: goodbye letter'),
    ('thinking', 'about', 'how'): (-40, 10, -30, 20, -20, 'crisis: thinking about method'),

    # === CRISIS GROUP 5: User = negative to others ===
