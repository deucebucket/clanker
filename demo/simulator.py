...
WORD_FORCES = {
    ...
    "how": (0, +5, -5, +10, 0),    # BRIDGE_FIX: "what": (0, +5, -5, +10, 0),
"why": (-5, +10, -5, +15, 0),    # BRIDGE_FIX: "when": (0, +5, 0, +15, 0),
"work": (+5, +10, +10, +15, 0), "make": (+5, +10, +10, +10, +5),
    ...
    "actually": (-8, +10, +10, +5, 0),    # BRIDGE_FIX: "well": (+5, +5, +5, 0, 0),
# ── Pronouns (context-sensitive) ──
    "i": (0, +3, +5, 0, 0), "you": (0, +5, 0, +5, 0),
    "we": (+5, +5, +5, 0, 0),    # BRIDGE_FIX: "they": (0, +3, 0, 0, 0),
"my": (0, +3, +5, 0, 0),    # BRIDGE_FIX: "your": (0, +5, 0, +5, 0),
"me": (0, +3, -5, 0, 0),
    ...
    "end": (-10, +10, +5, +10, -10),    # BRIDGE_FIX: "over": (-10, +5, 0, +5, -5),
"done": (-5, +5, +5, +5, 0), "finished": (-5, +5, +5, +5, 0),
    ...
    "behind": (-15, +10, -10, +10, -10),    # BRIDGE_FIX: "under": (-15, +10, -15, +10, -15),
"raising": (-10, +15, -5, +20, -5),        # "raising rent"
    ...
    "noticed": (+15, +10, +10, +5, +10),    # BRIDGE_FIX: "seen": (+15, +10, +10, +5, +10),
"invisible": (-20, +10, -20, +5, -15),
    ...
    "gone": (-60, -10, -50, 30, 35),    # BRIDGE_FIX: "here": (20, -5, 30, 0, 0),
"everywhere": (25, 35, 20, 10, -15),
    ...
    "tear": (-25, 25, -20, 10, -15),
    "teeth": (5, 10, 10, 5, 5),
    "thought": (10, 10, 10, 5, 0),    # BRIDGE_FIX: "through": (10, 15, 10, 10, 0),
"thursday": (5, 10, 5, 10, 0),
    ...
    # ── Gemini lexicon 15-17 ──    # BRIDGE_FIX: "after": (40, 25, 50, 45, 35),
"again": (25, 45, 30, 55, 10),
    "airport": (35, 75, 45, 85, 45),    # BRIDGE_FIX: "all": (60, 35, 75, 15, 40),
"allow": (65, 15, 50, 20, -15),    # BRIDGE_FIX: "and": (10, 5, 20, 5, 0),
"ankle": (10, 15, 25, 10, 15),
    ...
    "bed": (85, -45, 50, 0, -50),
    "beer-common": (50, 25, -15, 10, 15),    # BRIDGE_FIX: "before": (20, 35, 35, 60, 50),
"belt": (20, 10, 35, 5, 15),
    "bench": (70, -35, 35, 0, 40),
    "big": (35, 25, 55, 10, 70),
    "bit": (15, 5, 5, 5, 0),
    ...
    "low": (-25, -20, -35, 15, 65),
    "mail": (55, 40, 35, 60, 10),
    "man-human": (25, 15, 40, 5, 35),    # BRIDGE_FIX: "many": (40, 30, 45, 10, 20),
"marker": (30, 20, 25, 25, 5),
    ...
    "mop-verb": (35, 35, 40, 35, 35),    # BRIDGE_FIX: "more": (50, 40, 40, 30, -10),    # BRIDGE_FIX: "most": (55, 35, 55, 20, 20),
"mouth": (30, 25, 25, 15, 0),
    "move": (35, 55, 40, 45, -10),
    "nail": (0, 30, 20, 25, 25),
    ...
    "socks": (55, -20, 20, 5, 5),    # BRIDGE_FIX: "some": (10, 5, 10, 5, 5),
"south": (35, 20, 25, 5, 5),
    ...
    "stem": (25, 5, 25, 5, 15),
    "stick": (10, 5, 15, 10, 15),
    "sticky": (-55, 35, -15, 25, 15),    # BRIDGE_FIX: "still": (55, -45, 50, 15, 45),
"stir": (50, 25, 35, 30, 15),
    "stone": (20, -5, 40, 0, 65),
    ...
    "west": (25, 15, 25, 5, 10),
    "wet": (10, 20, 10, 20, 10),
    "wheel": (35, 25, 40, 15, 35),    # BRIDGE_FIX: "while": (35, -25, 40, 15, 10),
"whiteboard": (25, 10, 30, 10, 40),
    "windy": (20, 65, 15, 45, -20),
    "wine-common": (70, 15, 25, 5, 15),    # BRIDGE_FIX: "with": (60, 25, 40, 15, 0),
"woman-human": (30, 15, 40, 5, 20),
    ...
    # == Gap-fill: high-frequency benchmark words with emotional weight ==
    "thank": (+25, +10, +5, 0, +15), "lol": (+20, +15, +5, 0, +15),
    "wow": (+30, +35, +5, 0, +25), "haha": (+25, +15, +5, 0, +15),
    "omg": (+15, +35, -5, +10, +15), "lmao": (+25, +20, +5, 0, +15),
    "congrats": (+35, +25, +15, 0, +25),
    "fun": (+30, +20, +10, 0, +20), "funny": (+30, +20, +10, 0, +20),
    "favorite": (+35, +15, +15, 0, +20), "worth": (+20, +10, +10, 0, +10),
    "definitely": (+15, +15, +10, 0, +10),
    "charming": (+35, +10, +10, 0, +20), "engaging": (+30, +15, +10, 0, +15),
    "inventive": (+30, +15, +15, 0, +15), "affecting": (+25, +15, +5, 0, +10),
    "charisma": (+30, +15, +15, 0, +20), "kudos": (+30, +20, +15, 0, +20),
    "quirky": (+15, +10, +5, 0, +10), "treat": (+25, +10, +10, 0, +15),
    "poised": (+20, +5, +20, 0, +10), "intelligent": (+25, +10, +20, 0, +15),
    "thoughtful": (+25, +5, +15, 0, +15), "eloquent": (+30, +10, +20, 0, +15),
    "poignant": (+25, +20, +5, 0, +10), "witty": (+30, +15, +15, 0, +15),
    "dazzling": (+40, +30, +10, 0, +30), "gripping": (+30, +30, +10, 0, +10),
    "riveting": (+35, +35, +10, 0, +15), "heartfelt": (+35, +15, +10, 0, +20),
    "heartwarming": (+40, +15, +10, 0, +25), "memorable": (+30, +15, +15, 0, +20),
    "compelling": (+30, +20, +15, 0, +15), "entertaining": (+25, +15, +10, 0, +15),
    "humor": (+25, +15, +10, 0, +15), "wit": (+20, +10, +15, 0, +10),
    "cinematic": (+15, +10, +10, 0, +10), "original": (+15, +10, +10, 0, +10),
    "romantic": (+25, +15, +5, 0, +15), "regal": (+20, +5, +20, 0, +15),
    "loved": (+45, +25, +15, 0, +35), "hilarious": (+40, +30, +10, 0, +25),
    "charm": (+30, +10, +10, 0, +20), "deep": (+15, +10, +10, 0, +10),
    "winning": (+35, +25, +25, 0, +25), "rich": (+20, +10, +15, 0, +10),
    "wonder": (+15, +15, +5, 0, +15), "finally": (+15, +15, +10, +5, +10),
    "certainly": (+15, +10, +15, 0, +10), "laugh": (+30, +20, +10, 0, +20),
    "live": (+15, +15, +10, 0, +15), "friends": (+25, +10, +10, 0, +10),
    "fan": (+20, +15, +10, 0, +10), "fans": (+20, +15, +10, 0, +10),
    "bleak": (-35, +10, -20, +5, -30), "desperate": (-30, +30, -25, +20, -20),
    "devoid": (-25, +5, -15, +5, -15), "mindless": (-25, +10, -15, +5, -10),
    "wreck": (-35, +25, -20, +15, -20), "hampered": (-20, +10, -10, +5, -10),
    "uninspired": (-25, -10, -10, +5, -15), "formulaic": (-20, -10, -5, 0, -10),
    "predictable": (-15, -10, -5, 0, -10), "cliche": (-20, -5, -5, 0, -10),
    "vapid": (-30, -10, -10, 0, -15), "lifeless": (-35, -15, -15, 0, -25),
    "lackluster": (-25, -10, -10, 0, -15), "forgettable": (-20, -5, -10, 0, -10),
    "stupefying": (-30, +15, -10, +5, -15), "drab": (-25, -15, -10, 0, -15),
    "laziness": (-20, -15, -15, 0, -15),
    "worse": (-30, +15, -10, +10, -15), "lack": (-20, +5, -15, +5, -10),
    "unfortunately": (-25, +10, -10, +5, -15), "annoying": (-25, +20, +5, +10, +10),
    "scary": (-30, +35, -25, +15, +15), "losing": (-25, +20, -15, +15, -15),
    "yikes": (-25, +25, -10, +5, +5), "issues": (-15, +10, -10, +10, -5),
    "shocked": (-20, +40, -15, +10, +10),
    "but": (-5, +5, 0, +5, 0), "though": (-5, +5, 0, 0, 0),
    "despite": (-5, +10, +5, 0, 0), "although": (-5, +5, 0, 0, 0),
    "instead": (-5, +5, +5, +5, 0), "except": (-10, +5, 0, +5, 0),
    "still": (-5, +5, -5, +5, 0), "just": (-5, -5, -5, 0, 0),
    "only": (-5, +5, -5, +5, -5),
    "dont": (-10, +5, 0, +5, 0), "cant": (-15, +10, -15, +10, -5),
    "isn": (-10, +5, 0, +5, 0), "doesn": (-10, +5, 0, +5, 0),
    "didn": (-10, +5, 0, +5, 0),
    "haven't": (-10, +5, -5, +5, 0), "doesn't": (-10, +5, 0, +5, 0),
    "isn't": (-10, +5, 0, +5, 0), "aren't": (-10, +5, 0, +5, 0),
    "wasn't": (-10, +5, 0, +5, 0), "n't": (-10, +5, 0, +5, 0),
    "really": (+10, +15, +5, 0, +5), "super": (+15, +15, +10, 0, +10),
    "very": (+5, +10, 0, 0, 0), "truly": (+10, +15, +5, 0, +5),
    "easily": (+10, +5, +10, 0, +5),
    "well": (+10, +5, +5, 0, +5), "right": (+10, +5, +10, 0, +5),
    "even": (+5, +10, 0, +5, 0), "experience": (+15, +10, +10, 0, +10),
    "especially": (+10, +10, +5, 0, +5), "joke": (+15, +15, +5, 0, +10),
    "games": (+10, +15, +10, 0, +10), "play": (+15, +15, +10, 0, +10),
    "playing": (+15, +15, +10, 0, +10), "meme": (+15, +15, +5, 0, +10),
    "kids": (+10, +10, +5, 0, +10), "children": (+10, +10, +5, 0, +10),
    "able": (+10, +5, +15, 0, +5), "ideas": (+15, +10, +10, 0, +10),
    "helped": (+20, +10, +15, 0, +10), "hoping": (+15, +10, -5, +5, +10),
    "own": (+5, +5, +10, 0, +5), "sex": (+10, +25, +10, 0, +5),
    "major": (+10, +15, +10, +5, +5), "hit": (+10, +20, +10, +5, +5),
    "nah": (-10, -5, +5, 0, 0), "nope": (-10, +5, +5, 0, 0),
    "serious": (-5, +15, +15, +10, 0), "seems": (-5, +5, -5, 0, 0),
    "probably": (-5, +5, -5, 0, 0), "perhaps": (-5, -5, -5, 0, 0),
    "almost": (-5, +5, -5, +5, 0), "little": (-5, -5, -5, 0, -5),
    "downvote": (-15, +10, +5, +5, -5), "off": (-5, +5, 0, +5, 0),
    "situation": (-5, +10, -5, +10, 0), "needs": (-5, +10, -10, +20, -5),
    "it's": (0, +5, 0, 0, 0), "i'm": (0, +5, 0, 0, 0),
    "that's": (0, +5, 0, 0, 0), "they're": (0, +5, 0, 0, 0),
    "i've": (0, +5, 0, 0, 0), "i'll": (+5, +5, +5, +5, +5),
    "let's": (+10, +10, +10, +5, +10),
}
