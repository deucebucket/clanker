...
IDIOMS = {
    ...
    # Crisis / suicidal ideation — strong negative V and crushing G
    # These MUST be detected as complete phrases to override positive word contamination
    ("want", "to", "die"):        (-70, +30, -50, +60, -50, "crisis: want to die"),
    ("don't", "want", "to", "be", "here"): (-60, +20, -40, +50, -45, "crisis: don't want to be here"),
    ("end", "it", "all"):         (-65, +25, -45, +55, -50, "crisis: end it all"),
    ("no", "point"):              (-40, -10, -30, +10, -35, "crisis: no point"),
    ("what's", "the", "point"):   (-40, -5, -30, +10, -35, "crisis: what's the point"),
    ("want", "to", "disappear"):  (-55, +15, -40, +40, -40, "crisis: want to disappear"),
    ("better", "off", "without", "me"): (-60, +20, -45, +45, -45, "crisis: better off without me"),
    ("can't", "go", "on"):        (-55, +15, -45, +40, -40, "crisis: can't go on"),
    ("nobody", "would", "care"):  (-50, +10, -35, +30, -35, "crisis: nobody would care"),
    ("nobody", "would", "miss"):  (-50, +10, -35, +30, -35, "crisis: nobody would miss"),
    ("a", "burden"):              (-45, +15, -35, +20, -40, "crisis: a burden"),
    ("tired", "of", "everything"): (-35, -15, -25, +10, -30, "crisis: tired of everything"),
    ("ending", "it", "all"):      (-65, +25, -45, +55, -50, "crisis: ending it all"),
    ("ending", "it"):             (-55, +20, -40, +45, -40, "crisis: ending it"),
}
        ...
        for back_offset in range(min(window_back, current_idx + 1)):
            ...
            for idiom_words, forces in _IDIOM_STARTERS[first_word]:
                ...
                if match and idiom_len > best_len:
                    # Support both 5-element (vf, af, df, uf, label) and
                    # 6-element (vf, af, df, uf, gf, label) idiom tuples
                    if len(forces) == 6:
