...
PREFIXES = {
    ...
    # Additional prefixes
    "extra":   {"rule": "amplify", "v": 0.2,   "a": 0.3,  "d": 0.2,  "u": 0.1,  "g": 0.15},
    "inter":   {"rule": "modify",  "v": 0.05,  "a": 0.1,  "d": 0.0,  "u": 0.05, "g": 0.0},
    "trans":   {"rule": "modify",  "v": 0.05,  "a": 0.15, "d": 0.1,  "u": 0.1,  "g": 0.0},
    "multi":   {"rule": "amplify", "v": 0.1,   "a": 0.2,  "d": 0.1,  "u": 0.1,  "g": 0.1},
    "semi":    {"rule": "reduce",  "v": -0.1,  "a": -0.1, "d": -0.05,"u": 0.0,  "g": -0.05},
    "pseudo":  {"rule": "reduce",  "v": -0.2,  "a": 0.0,  "d": -0.1, "u": 0.0,  "g": 0.0},
    "micro":   {"rule": "reduce",  "v": -0.05, "a": -0.1, "d": -0.1, "u": 0.0,  "g": -0.05},
    "macro":   {"rule": "amplify", "v": 0.1,   "a": 0.15, "d": 0.15, "u": 0.05, "g": 0.1},
    "auto":    {"rule": "modify",  "v": 0.1,   "a": 0.0,  "d": 0.2,  "u": 0.0,  "g": 0.0},
}
...
SUFFIXES = {
    ...
    # Additional suffixes
    "ward":    {"rule": "modify",  "v": 0.0,   "a": 0.05, "d": 0.05, "u": 0.05, "g": 0.0},
    "proof":   {"rule": "amplify", "v": 0.15,  "a": -0.1, "d": 0.3,  "u": -0.1, "g": 0.05},
    "dom":     {"rule": "modify",  "v": 0.0,   "a": 0.0,  "d": 0.1,  "u": 0.0,  "g": 0.0},
    "hood":    {"rule": "modify",  "v": 0.05,  "a": 0.0,  "d": 0.05, "u": 0.0,  "g": 0.0},
    "ship":    {"rule": "modify",  "v": 0.05,  "a": 0.05, "d": 0.05, "u": 0.0,  "g": 0.0},
    "ling":    {"rule": "reduce",  "v": 0.1,   "a": -0.1, "d": -0.15,"u": 0.0,  "g": -0.05},
    "esque":   {"rule": "modify",  "v": 0.1,   "a": 0.05, "d": 0.0,  "u": 0.0,  "g": 0.0},
}
...
ROOTS = {
    ...
    # ── Latin/Greek roots ──
    "bene":     (+40, +10, +20, 0, +20),      # beneficial — positive, rises
    "mal":      (-40, +20, -10, +10, -15),     # malice — negative, sinks
    "mort":     (-60, +30, -40, +20, -50),     # mortality — heavy, crushing
    "vit":      (+40, +20, +20, 0, +20),       # vital — life energy, rises
    "liber":    (+45, +25, +35, 0, +30),       # liberty — freeing, soaring
    "serv":     (+15, +10, -10, +10, 0),       # serve — neutral functional
    "rupt":     (-30, +45, -15, +25, +15),     # rupture — explosive, rises
    "tract":    (-10, +15, +10, +10, 0),       # extract — neutral functional
    "dict":     (+5, +10, +15, +5, 0),         # dictate — neutral functional
    "port":     (+10, +10, +10, +10, 0),       # transport — neutral functional
    "ject":     (-10, +20, +5, +15, +10),      # eject — throwing upward
    "cred":     (+25, +10, +20, 0, +10),       # credible — positive, slight rise
    "fort":     (+25, +15, +30, 0, +10),       # fortify — strength, grounded+
    "pend":     (-15, +15, -15, +15, -10),     # pending — hanging, slight sink
    "sens":     (+10, +20, -5, +5, +5),        # sense — slight rise
    "phil":     (+40, +20, +10, 0, +25),       # philosophy/love — rises
    "psych":    (+5, +15, +5, +5, +5),         # psyche — slight rise
    "soph":     (+20, +10, +20, 0, +10),       # wisdom — slight rise
    "chron":    (-5, +5, 0, +15, 0),           # time — neutral
    "gen":      (+15, +10, +10, 0, +10),       # generate — creative, rises
    "nov":      (+20, +20, +10, +5, +15),      # novel — new, rises
    "clar":     (+20, +10, +15, 0, +10),       # clarity — positive, rises
    "grav":     (-25, +15, -15, +15, -30),     # gravity — heavy by definition
    "lev":      (+20, +10, +15, 0, +20),       # levitate — light, rises
    "press":    (-20, +20, -15, +15, -20),     # pressure — crushing, sinks
    "tens":     (-15, +25, -10, +15, +10),     # tension — high arousal, rises
    "sol":      (+15, -10, +15, 0, +5),        # solace — calm positive
    "vac":      (-10, -15, -10, 0, -5),        # vacuum — empty, slight sink
    "cap":      (+10, +15, +20, +5, +5),       # capable — slight rise

    # ── Emotional core roots ──
    "ennui":    (-20, -25, -15, 0, -20),       # boredom — low arousal negative, sinks
    "yearn":    (-15, +20, -15, +10, +10),     # yearning — aching upward reach
    "pang":     (-30, +30, -15, +15, +10),     # pang — sharp, rises briefly
    "blush":    (-15, +25, -20, +5, +10),      # blush — heat rises
    "thrill":   (+50, +50, +20, 0, +40),       # thrill — exhilarating, soars
    "glow":     (+35, +15, +15, 0, +20),       # glow — warm positive, rises
    "sting":    (-25, +30, -15, +15, +10),     # sting — sharp, rises
    "sooth":    (+30, -20, +20, 0, +5),        # soothe — calm positive, grounded
    "haunt":    (-35, +25, -25, +10, -20),     # haunt — lingering, sinks
    # "dread" already defined above
    "gleam":    (+25, +15, +10, 0, +15),       # gleam — light, rises
    "wilt":     (-25, -15, -20, +5, -20),      # wilt — wilting, sinks
    "bloom":    (+35, +20, +15, 0, +25),       # bloom — growing upward
    "rot":      (-40, +15, -25, +10, -30),     # rot — decay, sinks
    "thrive":   (+40, +25, +25, 0, +25),       # thrive — positive energy, rises
    "languish": (-30, -20, -25, +10, -30),     # languish — low arousal negative, sinks
    "exalt":    (+45, +35, +30, 0, +45),       # exalt — soaring triumph
    "lament":   (-40, +20, -25, +10, -30),     # lament — grief, sinks
    "revel":    (+40, +35, +20, 0, +30),       # revel — joyous energy, rises
    "brood":    (-25, +15, -10, +5, -15),      # brood — dark rumination, sinks
    "sulk":     (-25, +10, -20, +5, -20),      # sulk — low arousal negative, sinks
    "fret":     (-20, +25, -20, +15, +5),      # fret — anxious, slight rise
    "pine":     (-30, +15, -20, +10, -20),     # pine — longing, sinks
    "smolder":  (-20, +30, +10, +10, +15),     # smolder — heat building, rises
    "flutter":  (+15, +30, -10, +5, +20),      # flutter — light, airy, rises
    "simmer":   (-20, +25, +10, +10, +10),     # simmer — heat building, rises
    "quake":    (-25, +40, -30, +20, +15),     # quake — high arousal fear, rises
    "tremble":  (-25, +35, -30, +15, +10),     # tremble — fear response, rises
    "shudder":  (-25, +35, -25, +15, +10),     # shudder — fear response, rises

    # ── Action/state roots ──
    "clos":     (-10, +5, +5, +5, 0),          # close — neutral functional
    "open":     (+15, +15, +10, +5, +10),      # open — positive, slight rise
    "bind":     (-15, +10, -15, +10, -10),     # bind — constraining, sinks
    "lock":     (-20, +15, -20, +15, -15),     # lock — trapped, sinks
    "trap":     (-35, +30, -35, +20, -25),     # trap — constrained, sinks
    "shield":   (+20, +15, +30, 0, +10),       # shield — protective, grounded+
    "guard":    (+15, +15, +25, +5, +5),        # guard — protective, grounded
    "nourish":  (+30, +10, +20, 0, +15),       # nourish — nurturing, rises
    "starv":    (-40, +30, -30, +25, -30),     # starve — depleting, sinks
    "wound":    (-35, +30, -25, +20, -15),     # wound — painful, sinks
    "mend":     (+25, +10, +20, +5, +10),      # mend — healing, slight rise
    "wreck":    (-40, +35, -25, +25, -20),     # wreck — destruction, sinks
    "craft":    (+25, +15, +20, +5, +10),      # craft — creative, slight rise
    "ruin":     (-45, +30, -30, +20, -35),     # ruin — destruction, sinks
    "bless":    (+45, +15, +20, 0, +30),       # bless — sacred positive, rises
    "curse":    (-40, +30, -15, +15, +15),     # curse — anger rises
    "prais":    (+40, +20, +20, 0, +25),       # praise — uplifting
    "mock":     (-30, +25, +15, +10, +15),     # mock — contempt rises
    "scorn":    (-35, +25, +20, +10, +20),     # scorn — contempt rises
    "honor":    (+40, +20, +30, 0, +20),       # honor — dignified, rises
    "empower":  (+35, +25, +40, +5, +25),      # empower — lifting up
    "oppress":  (-40, +25, -40, +15, -35),     # oppress — crushing down
    "liberat":  (+45, +30, +40, +5, +35),      # liberate — freeing, soaring
    "captiv":   (-30, +20, -35, +15, -25),     # captive — trapped, sinks
    "erupt":    (-30, +55, +15, +30, +30),     # erupt — explosive, rises
    "nurtur":   (+35, +10, +25, 0, +15),       # nurture — caring, rises
    "neglect":  (-35, +10, -30, +10, -20),     # neglect — low arousal negative, sinks
    # "cherish" already defined above
    "devast":   (-55, +40, -35, +25, -40),     # devastate — crushing, sinks
    "tortur":   (-55, +50, -40, +30, -30),     # torture — intense pain, sinks
    "sancti":   (+30, +10, +25, 0, +20),       # sanctify — sacred, rises
    "corrupt":  (-40, +25, -15, +15, -15),     # corrupt — decay, sinks
    "purif":    (+30, +15, +20, 0, +20),       # purify — cleansing, rises
    "pollut":   (-30, +15, -15, +15, -15),     # pollute — contaminating, sinks
    "deplet":   (-25, +15, -20, +15, -20),     # deplete — draining, sinks
    "restor":   (+30, +15, +20, +5, +15),      # restore — rebuilding, rises
    "demolish": (-40, +40, -20, +25, -15),     # demolish — destruction, sinks
    "construct": (+25, +20, +25, +10, +10),    # construct — building, slight rise
    "flourish": (+40, +25, +25, 0, +30),       # flourish — thriving, rises
    "perish":   (-50, +30, -40, +25, -40),     # perish — death, sinks
    "vanquish": (+20, +35, +40, +10, +20),     # vanquish — triumph, rises
    "relinquish": (-20, +10, -25, +5, -15),    # relinquish — letting go, sinks
    "extinguish": (-25, +20, -15, +15, -15),   # extinguish — ending, sinks
    "distinguish": (+20, +15, +20, +5, +5),    # distinguish — neutral, slight rise

    # ── Everyday roots ──
    "cook":     (+20, +10, +15, 0, +5),        # cooking — warm, grounded
    "eat":      (+15, +10, +10, 0, 0),         # eating — grounded
    "drink":    (+10, +10, +5, 0, 0),          # drinking — grounded
    "sleep":    (+10, -20, +10, 0, -5),        # sleep — settling down
    "wake":     (+5, +20, +10, +5, +10),       # wake — rising up
    "play":     (+35, +25, +15, 0, +20),       # play — light, buoyant
    "sing":     (+30, +25, +10, 0, +20),       # sing — voice rises
    "danc":     (+35, +30, +15, 0, +25),       # dance — light on feet, rises
    "laugh":    (+45, +35, +20, 0, +30),       # laugh — bubbling up
    "cry":      (-35, +30, -20, +10, -20),     # cry — tears fall
    "scream":   (-20, +55, +10, +25, +25),     # scream — voice rises high
    "whisper":  (+5, -20, -5, +5, -5),         # whisper — quiet, low
    "hug":      (+40, +15, +10, 0, +15),       # hug — warm embrace, rises
    "kiss":     (+45, +25, +10, 0, +20),       # kiss — affectionate, rises
    "slap":     (-30, +40, +15, +15, +10),     # slap — sharp, rises
    "punch":    (-30, +50, +25, +20, +15),     # punch — forceful, rises
    "kick":     (-25, +40, +20, +15, +10),     # kick — forceful, rises
    "push":     (-15, +25, +15, +10, +5),      # push — directional, slight rise
    "pull":     (-10, +20, +10, +10, -5),      # pull — drawing down
    "grab":     (-10, +25, +15, +15, +5),      # grab — seizing, slight rise
    "throw":    (-15, +35, +15, +15, +15),     # throw — launching upward
    "catch":    (+10, +20, +15, +10, +5),      # catch — receiving, slight rise
    "climb":    (+15, +25, +20, +10, +20),     # climb — ascending, rises
    "swim":     (+15, +20, +15, 0, +5),        # swim — buoyant, slight rise
    "drive":    (+10, +15, +15, +5, +5),       # drive — forward motion
    "crash":    (-40, +45, -20, +35, -25),     # crash — falling, sinks
    "collid":   (-35, +45, -15, +30, -15),     # collide — impact, sinks
    "explor":   (+25, +25, +20, +5, +15),      # explore — outward, rises
    "wander":   (+10, +10, -5, 0, +5),         # wander — drifting, slight rise
    "search":   (+5, +20, +10, +15, +5),       # search — seeking, slight rise
    "find":     (+25, +20, +15, +5, +15),      # find — discovery, rises
    "discov":   (+30, +30, +20, +5, +20),      # discover — revelation, rises
    "invent":   (+30, +25, +25, +5, +20),      # invent — creative, rises
    "teach":    (+25, +15, +20, +5, +10),      # teach — sharing, rises
    "studi":    (+10, +15, +10, +10, +5),      # study — neutral, grounded
    "read":     (+15, +10, +10, 0, +5),        # read — calm positive
    "write":    (+15, +15, +15, +5, +5),       # write — creative, grounded
    "draw":     (+20, +15, +10, 0, +10),       # draw — creative, slight rise
    "paint":    (+20, +15, +10, 0, +10),       # paint — creative, slight rise
    "sculpt":   (+20, +15, +15, 0, +5),        # sculpt — grounded creative
    "design":   (+20, +20, +20, +5, +10),      # design — creative, rises
    # "fix" already defined above
    "repair":   (+15, +15, +20, +10, +5),      # repair — restoring, grounded
    "clean":    (+15, +10, +15, 0, +5),        # clean — refreshing, slight rise
    "organiz":  (+15, +10, +20, +5, +5),       # organize — orderly, grounded
